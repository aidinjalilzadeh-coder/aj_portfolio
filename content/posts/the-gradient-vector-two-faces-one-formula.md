...
<figure style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
  ...
  >
  <figcaption style="width: 100%; text-align: center; margin-top: 8px;">
    <strong>Figure 2:</strong> Different views of gradient for a fixed point. The thick orange curve on the lower plot is the path of steepest change. Takes you uphill from $A'$ if you follow along the blue arrow.
  </figcaption>
</figure>
