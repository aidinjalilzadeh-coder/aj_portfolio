...
Newton and Leibniz agreed up to equation $(4)$. The divergence came after they tried to make the approximate value, *exact*. Anyone can see from the diagram that as $\delta x$ gets smaller then $\delta y$ begins to shrink and therefore the error will also shrink markedly. This was literally their justification— very much intuitive and nothing rigorous. Bear in mind that the concept of limits as we know it today came to existence nearly two centuries after Newton and Leibniz. In other words there was no solid mathematical theory for computing limits. Even $x \to a$ ($x$ *tends to* $a$) was not defined. So, things had to be done intuitively in the 1680s. But no matter what, their methods worked and stood the test of time, as confirmed by many mathematicians afterwards.
