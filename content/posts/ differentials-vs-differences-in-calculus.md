...
Alright, I digress! Let's get down to the actual dispute. N & L both realised that $\delta x$ must become very small. One may say that: “ …$\emph{\text{well, the smallest non-negative number is zero!}}$”
