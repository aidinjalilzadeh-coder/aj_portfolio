...
There is, of course, a half-century gap between Jakob Bernoulli's insights and the formal development of variational calculus as we know it today. The breakthrough finally came in August 1755 when the 19-year-old Lagrange proposed his **purely analytic** and **algebraic method** for solving variational problems like the brachistochrone. This was revealed in a letter to Euler — a mentor whom the young Lagrange admired greatly. Notice that in 1744, Euler had already published his treatise *Methodus inveniendi* ("a method of finding"), a collection of variational problems that effectively founded the field. It was groundbreaking work: Euler unified a range of problems under a single discipline. But his treatment remained heavily geometric and cumbersome, demanding advanced insight and considerable skill. The stage was set for a new approach — and Lagrange delivered it. The name **variational calculus** was officially announced for the field by Euler in a 1756 lecture. This was after Euler adopted Lagrange's analytic method for his subsequent work.
