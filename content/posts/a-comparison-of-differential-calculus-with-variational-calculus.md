...
A functional maps functions from $C^1(\left\[a, b \right]$ onto $\mathbb{R^{>0}}$. $C^1$ is the space of all continuous functions over $\left\[a,b\right]$ with continuous first derivatives.
