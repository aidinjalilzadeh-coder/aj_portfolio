...
which eventually implies that $y'(x)$ is constant. This is exactly the result we were hoping to reach — from differential calculus you know if the first derivative is constant then the function is a linear polynomial of the form $y(x)=mx+h$, i.e. *equation of a straight line!*
