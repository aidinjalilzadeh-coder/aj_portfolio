...
A functional maps functions from $C^1 \left(a, b \right)$ onto $\mathbb{R^{>0}}$. $C^1$ is the space of all continuous functions over $(a,b)$ with continuous first derivatives.
