...
We know that the **shortest path** connecting two distinct points in 2-D or 3-D space is a **straight line**. This rather trivial fact is indeed a variational problem which goes back to Euclid and he proves it early on in his Book I. He does so by first proving the triangle inequality showing in any triangle each side is shorter than the sum of the other two. It was a clever proof for its time but it was limited to polygonal paths only since he couldn't calculate the length of a curved path. In other words it was incimplete! In 1728 Johann Bernoulli assigned this problem as homework to Euler. Euler was taught differential calculus and he was familiar with infinitesimals so he assumed a curve to be the limit of a polygon with infinitesimal sides. He did prove it but again the generality was lost!
